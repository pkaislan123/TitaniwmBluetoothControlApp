...
public class Termometro extends View {
    ...
    public void setTempAtual(float currentTemp) {
    ...
    public void init(Context context, AttributeSet attrs) {
        TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.Termometro);
        outerCircleRadius = typedArray.getDimension(R.styleable.Termometro_radius, 20f);
        int outerColor = typedArray.getColor(R.styleable.Termometro_outerColor, Color.GRAY);
        int middleColor = typedArray.getColor(R.styleable.Termometro_middleColor, Color.WHITE);
        int innerColor = typedArray.getColor(R.styleable.Termometro_innerColor, Color.RED);
